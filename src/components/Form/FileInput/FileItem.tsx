  ...
  variants: {
    state: {
      ...
      error: {
        ...
        deleteButton:
          'text-error-700 hover:text-error-900 dark:text-error-400 dark:hover:bg-error-900 dark:hover:text-error-300',
      },
      complete: {
        container: 'border-violet-300 dark:border-violet-300/30',
      },
    },
  },
